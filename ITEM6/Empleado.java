...
{
     /*nota:
     *  Modificamos los atributos originales de Empleado (previamente este poseia Nombre y apellido)
     * pero al realizar la herencia simple de Persona a este mismo se genera un duplicamiento de los mismos atributos
     * por lo que decide quitarlos para asi almacenar los datos y no tener un null en su lugar.
     */
    private long cuil;
