...
public class AplicacionFacultad
{
    ...
    public static void main(String[] args )
    {
       ...
       Profesor profe = new Profesor("Valenzuela","Lisandro",43268917,2002,"Analista Programador Universitario", cargos);
       Profesor profe2 = new Profesor("Vivero","Edgardo",43262917,2002,"Analista Programador Universitario", cargos2);
       Profesor profe3= new Profesor("Bonavena","Oscar",14981107,1942,"DOCTOR EN INFORMATICA",cargos2);
